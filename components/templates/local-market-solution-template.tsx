...
export function LocalMarketSolutionTemplate({
  ...
  return (
    <div className="bg-[#2f3b2d] text-[#f3f1ea]">
      <section className="relative overflow-hidden border-b border-white/14 pt-28 lg:pt-32">
        ...
        <div className="relative mx-auto w-full max-w-[1680px] px-6 pb-14 pt-6 sm:px-8 md:px-12 lg:px-16 lg:pb-20">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:items-end">
            ...
            <MotionReveal direction="right" className="md:col-span-3 md:col-start-10 md:pb-2">
              <p className="border-t border-white/14 pt-5 text-[15px] leading-7 text-white/76">{subtitle}</p>
            </MotionReveal>
          </div>

          <MotionReveal className="mt-16 grid grid-cols-1 gap-8 border-t border-white/14 pt-10 md:mt-20 md:grid-cols-12 md:items-end">
            ...
            <div className="md:col-span-2 md:col-start-11">
              <Link href="/contact" className="group inline-flex items-center gap-2 rounded-full bg-[#f3f1ea] px-5 py-3 text-[10px] font-medium uppercase tracking-[0.16em] text-[#2f3b2d] transition-transform duration-300 hover:-translate-y-0.5">
        ...
        <div className="relative mx-auto flex w-full max-w-[1680px] items-center justify-between border-t border-white/14 px-6 py-5 text-[9px] uppercase tracking-[0.2em] text-white/42 sm:px-8 md:px-12 lg:px-16">
      ...
      <main className="mx-auto w-full max-w-[1680px] px-6 sm:px-8 md:px-12 lg:px-16">
        <section className="border-b border-white/14 py-16 lg:py-24" aria-labelledby={`${index}-highlights`}>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            ...
            <div className="md:col-span-8 md:col-start-5">
              <div className="grid grid-cols-1 border-l border-t border-white/14 sm:grid-cols-2">
                {highlightCards.map((card, cardIndex) => (
                  <MotionReveal key={card.title} direction={cardIndex % 2 === 0 ? "left" : "right"}>
                    <article className="group min-h-[220px] border-b border-r border-white/14 p-6 transition-colors duration-300 hover:bg-[#5c6f58]/40 lg:min-h-[250px] lg:p-8">
                      <div className="flex items-start justify-between gap-4">
                        <span className="text-[9px] tracking-[0.2em] text-[#a8542a]">{String(cardIndex + 1).padStart(2, "0")}</span>
                        {card.meta ? <span className="text-[9px] uppercase tracking-[0.16em] text-white/40">{card.meta}</span> : null}
                      </div>
        ...
        <section className="border-b border-white/14 py-16 lg:py-24">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
            <div className="md:col-span-8">
              {sections.map((section, sectionIndex) => (
                <MotionReveal key={section.title} direction={sectionIndex % 2 === 0 ? "left" : "right"}>
                  <article className="grid grid-cols-1 border-t border-white/14 py-12 md:grid-cols-8 md:gap-8 lg:py-16">
                    <div className="md:col-span-3">
                      <p className={sectionLabelClass}>{section.label}</p>
                      <span className="mt-3 block h-px w-10 bg-[#a8542a]" aria-hidden="true" />
                      <h2 className={sectionTitleClass}>{section.title}</h2>
                    </div>
                    <div className="mt-8 max-w-[34rem] text-[15px] leading-8 text-white/76 md:col-span-5 md:mt-0 [&_a]:border-b [&_a]:border-white/45 [&_a]:font-medium [&_a]:text-[#f3f1ea] [&_a]:transition-colors hover:[&_a]:border-[#a8542a]">
                      {section.content}
                    </div>
                  </article>
                </MotionReveal>
              ...
              <MotionReveal>
                <div className="border-t border-white/14 py-10 lg:py-12">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/44">Related Paths</p>
                  <div className="mt-5 border-t border-white/14">
                    {relatedLinks.map((item) => (
                      <Link key={item.href} href={item.href} className="group flex items-start justify-between gap-5 border-b border-white/14 py-5 transition-colors hover:bg-[#5c6f58]/30 sm:px-1">
                        <div className="max-w-[34rem]">
                          <p className="text-[15px] font-semibold leading-6 text-[#f3f1ea]">{item.title}</p>
            ...
            <MotionReveal direction="right" className="md:col-span-3 md:col-start-10">
              <aside className="sticky top-28 border-t border-white/14 bg-[#202820] px-6 py-7 text-[#f6f3ea] lg:px-7 lg:py-8">
        ...
        <section className="border-b border-white/14 py-16 lg:py-24" aria-labelledby={`${index}-process`}>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <MotionReveal direction="left" className="md:col-span-3">
            ...
            <div className="md:col-span-8 md:col-start-5">
              {processSteps.map((step, stepIndex) => (
                <MotionReveal key={step.title} direction={stepIndex % 2 === 0 ? "left" : "right"}>
                  <article className="grid grid-cols-[44px_1fr] gap-5 border-t border-white/14 py-7 last:border-b sm:grid-cols-[56px_1fr] lg:grid-cols-[64px_220px_1fr] lg:gap-8 lg:py-8">
        ...
        <MotionReveal>
          <section className="border-b border-white/14 py-12 lg:py-16">
        ...
        <section className="border-b border-white/14 py-16 lg:py-24" aria-labelledby={`${index}-support`}>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <MotionReveal direction="left" className="md:col-span-3">
            ...
            <div className="grid grid-cols-1 md:col-span-8 md:col-start-5 lg:grid-cols-2">
              {supportCards.map((card, cardIndex) => (
                <MotionReveal key={card.title} direction={cardIndex === 0 ? "left" : "right"}>
                  <article className={`flex min-h-[330px] flex-col border border-white/14 p-7 lg:min-h-[390px] lg:p-9 ${card.active ? "bg-[#202820] text-[#f6f3ea]" : "bg-[#5c6f58]/20 text-[#f3f1ea]"}`}>
        ...
        <section className="border-b border-white/14 py-16 lg:py-20" aria-labelledby={`${index}-faq-title`}>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <div className="md:col-span-3">
            ...
            <div className="md:col-span-8 md:col-start-5">
              {faqs.map(({ q, a }, faqIndex) => (
                <MotionReveal key={q}>
                  <div className="grid grid-cols-[38px_1fr] gap-4 border-t border-white/14 py-7 last:border-b sm:grid-cols-[54px_1fr]">
                    <span className="pt-1 text-[9px] tracking-[0.2em] text-white/36">{String(faqIndex + 1).padStart(2, "0")}</span>
        ...
        <MotionReveal>
          <section className="grid grid-cols-1 border-b border-white/14 py-16 md:grid-cols-12 md:items-end lg:py-20">
            <div className="md:col-span-3">
