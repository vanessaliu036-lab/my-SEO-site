  ...
  return (
    <div className="bg-occ-background text-occ-primary">
      ...
      <main className="mx-auto w-full max-w-[1360px] px-6 sm:px-8 md:px-12 lg:px-16">
        ...
        <section className="border-b border-black/10 py-16 lg:py-24" aria-labelledby={`${index}-support`}>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <MotionReveal direction="left" className="md:col-span-3">
              ...
              {faqs.map(({ q, a }, faqIndex) => (
                <MotionReveal key={q}>
                  <details className="group border-t border-black/10 last:border-b">
                    ...
                    <div className="max-w-[40rem] pb-7 pl-[54px] text-sm leading-7 text-black/76 sm:pl-[70px]">{a}</div>
                  </details>
                </MotionReveal>
              ))}
            </div>
