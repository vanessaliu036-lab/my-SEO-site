      ...
      <section className="relative overflow-hidden border-b border-black/10 pt-28 lg:pt-32">
        ...
        <div className="relative mx-auto grid min-h-[68svh] w-full max-w-[1680px] grid-cols-1 items-end gap-10 px-6 pb-16 sm:px-8 md:grid-cols-12 md:px-12 lg:px-16 lg:pb-20">
          <MotionReveal direction="left" className="md:col-span-3 md:pb-3">
            ...
            <p className="mt-6 max-w-xs text-[15px] leading-7 text-black/52">
          ...
          <MotionReveal className="md:col-span-7 md:col-start-4">
            <h1 className="font-[var(--font-display)] text-[clamp(5.2rem,10vw,10rem)] font-normal leading-[0.78] tracking-[-0.065em]">
              SOLUTIONS
            </h1>
          </MotionReveal>
        ...
        <section className="border-b border-black/10 py-16 lg:py-24" aria-labelledby="solutions-programs-title">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <div className="md:col-span-3">
              ...
              <h2 id="solutions-programs-title" className="mt-5 font-[var(--font-display)] text-5xl font-normal leading-[0.92] tracking-[-0.045em] sm:text-6xl">
                One operating
                <br />ecosystem.
              </h2>
            </div>
              ...
              {services.map((service, index) => (
                <MotionReveal key={service.href} direction={index % 2 === 0 ? "left" : "right"}>
                  <Link href={service.href} className="group grid grid-cols-[42px_1fr_auto] items-end gap-4 border-t border-black/10 py-8 last:border-b sm:grid-cols-[56px_1fr_auto] lg:py-10">
                    <span className="pb-1 text-[9px] tracking-[0.2em] text-black/32">{String(index + 1).padStart(2, "0")}</span>
                    <div>
                      <h3 className="font-[var(--font-display)] text-4xl font-normal leading-none tracking-[-0.045em] transition-transform duration-300 group-hover:translate-x-2 sm:text-5xl lg:text-6xl">
                        {service.title}
                      </h3>
                      <p className="mt-3 max-w-xl text-[11px] uppercase leading-6 tracking-[0.13em] text-black/42">{service.desc}</p>
                    </div>
        ...
        <MotionReveal>
          <section className="grid grid-cols-1 border-b border-black/10 py-16 md:grid-cols-12 md:items-end lg:py-20">
            ...
            <div className="mt-8 md:col-span-6 md:col-start-7 md:mt-0">
              <p className="max-w-xl text-[15px] leading-8 text-black/52">
