...
export default async function BlogPostPage({
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f6f3ea] text-stone-950 overflow-x-hidden">
        ...
        {/* Breadcrumb nav */}
        <nav className="sticky top-0 z-40 bg-[#f6f3ea]/90 backdrop-blur-sm border-b border-stone-200">
