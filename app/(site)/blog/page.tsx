...
export const metadata: Metadata = {
  ...
  description:
    "Explore OCC's journal on Cambodian coffee, Fine Robusta, processing, roasting, quality, origins, producers and buyer intelligence.",
  alternates: alternatesFromCanonical(`${siteUrl}/blog`),
  openGraph: {
    title: "Cambodia Coffee Journal | Origin Coffee Cambodia",
    description:
      "Research, origin and commercial coffee intelligence from Origin Coffee Cambodia.",
    url: `${siteUrl}/blog`,
    siteName,
    locale: "en_US",
    type: "website",
      ...
      <section className="overflow-hidden bg-occ-background text-occ-primary">
        <div className="mx-auto grid min-h-[620px] w-full max-w-[1360px] lg:grid-cols-[44%_56%]">
          <div className="relative min-h-[430px] overflow-hidden sm:min-h-[520px] lg:min-h-[620px]">
            <img
              src="/about/occ-about-green-hero.webp"
          ...
          <div className="relative flex min-h-[480px] flex-col justify-center px-6 py-14 sm:px-10 lg:min-h-[620px] lg:px-16 xl:px-20">
            <p className="mb-5 text-[10px] font-semibold uppercase tracking-[0.24em] text-occ-burgundy">
              OCC Journal
            </p>
            ...
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -bottom-32 -right-24 h-[310px] w-[460px] rotate-[-17deg] rounded-tr-[100%] border-r border-t border-occ-primary/25"
            />
          </div>
        </div>
      </section>
      ...
      <section id="blog-categories" className="bg-[#FAF7F2] py-16 sm:py-20 lg:py-24">
        <div className="mx-auto w-full max-w-[1360px] px-5 sm:px-8 lg:px-12">
          <header className="mb-10 text-center sm:mb-12">
            <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.24em] text-occ-burgundy">
              Explore by topic
            </p>
          ...
          <div className="grid gap-x-7 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
            {blogCategories.map((category) => (
              ...
              >
                ...
                <p className="mt-4 font-[var(--font-display)] text-[13px] text-occ-primary/48">
                  OCC Journal
                </p>
                ...
                <div className="mt-3 flex items-center justify-between gap-4 border-b border-occ-primary/18 pb-4">
                  <span className="text-[8px] font-medium uppercase tracking-[0.23em] text-occ-primary/56">
                    {category.kicker}
                  </span>
                  <span className="text-lg leading-none text-occ-primary/50 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-occ-burgundy" aria-hidden="true">
                    →
                  </span>
                </div>
              </Link>
