...
export const metadata: Metadata = {
  title: "OCC Partnerships | Cambodian Coffee Gifts with ARUNERA",
  description:
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Partnerships", item: `${siteUrl}/partnerships` },
  ],
}
...
const pageSchema = {
  ...
  url: `${siteUrl}/partnerships`,
  name: "OCC Partnerships | Cambodian Coffee Gifts with ARUNERA",
  description:
        ...
        <section className="relative overflow-hidden bg-[#182019] text-[#f6f3ea]">
          ...
          <div className="relative mx-auto grid min-h-[72svh] w-full max-w-[1680px] grid-cols-1 content-end px-6 pb-16 pt-28 sm:px-8 md:grid-cols-12 md:px-12 lg:px-16 lg:pb-20">
            <div className="md:col-span-9 lg:col-span-8">
              <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-white/58">Partnerships · OCC × ARUNERA</p>
