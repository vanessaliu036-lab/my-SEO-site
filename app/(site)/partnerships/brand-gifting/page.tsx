...
export const metadata: Metadata = {
  ...
  alternates: pageAlternates("/partnerships/brand-gifting"),
  openGraph: {
    title: "OCC Brand & Gifting | Cambodian Coffee Gifts with ARUNERA",
    description:
    ...
    url: `${siteUrl}/partnerships/brand-gifting`,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Brand & Gifting", item: `${siteUrl}/partnerships/brand-gifting` },
  ],
}
