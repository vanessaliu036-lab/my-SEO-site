...
const labelBase =
  "block text-[10px] tracking-[0.2em] uppercase text-[#9a9a9a] mb-2.5 [font-family:var(--occ-font-subtitle)]"
...
export default function ContactForm() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f2ef] [font-family:var(--occ-font-body)] relative">
      <nav aria-label="Breadcrumb" className="absolute top-8 left-8 z-20 flex items-center gap-4">
        <Link
          href="/"
          className="flex items-center gap-2 text-[11px] tracking-[0.15em] uppercase text-[#5a5a5a] hover:text-[#0f0f0f] transition-colors [font-family:var(--occ-font-subtitle)]"
          aria-label="Return to homepage"
        >
          <span className="inline-block w-5 h-px bg-current" aria-hidden="true" />
          Home
        </Link>
        <span className="text-[11px] text-[#9a9a9a] [font-family:var(--occ-font-subtitle)]">/ Contact</span>
      </nav>
      ...
      <div className="grid md:grid-cols-2 min-h-screen pt-20">
        <div className="relative flex flex-col justify-between p-10 md:p-16 border-b md:border-b-0 md:border-r border-[#d0cdc8]">
          <div className="flex items-center gap-3 mb-10 text-[11px] tracking-[0.2em] text-[#9a9a9a] uppercase [font-family:var(--occ-font-subtitle)]">
            <span className="inline-block w-8 h-px bg-[#9a9a9a]" />
            Contact
          </div>

          <div>
            <h1 className="leading-[0.92] tracking-[0.02em] text-[#0f0f0f] mb-8 [font-family:var(--occ-font-title)]" style={{ fontSize: "clamp(64px, 8vw, 110px)" }}>
              GET IN<br />TOUCH.
            </h1>
        ...
        <div className="flex flex-col justify-center p-10 md:p-16">
          <div className="mb-12">
            <p className="text-[11px] tracking-[0.15em] text-[#9a9a9a] uppercase mb-2 [font-family:var(--occ-font-subtitle)]">01 / Contact Form</p>
            <p className="text-[22px] font-medium tracking-[0.08em] uppercase text-[#0f0f0f] [font-family:var(--occ-font-subtitle)]">Start an Enquiry</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <fieldset className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-2.5 mt-1">
                {ENQUIRY_TYPES.map((type) => {
                  ...
                  return (
                    <label key={type} className={`flex items-center gap-2.5 px-3.5 py-3 border cursor-pointer transition-all text-[12px] tracking-[0.1em] uppercase [font-family:var(--occ-font-subtitle)] ${isSelected ? "bg-[#0f0f0f] text-[#f4f2ef] border-[#0f0f0f]" : "border-[#d0cdc8] text-[#5a5a5a] hover:border-[#5a5a5a] hover:text-[#0f0f0f]"}`}>
            ...
            <div className="flex items-center justify-end mt-12 pt-8 border-t border-[#d0cdc8]">
              <button type="submit" disabled={isPending} className="flex items-center gap-3.5 bg-[#0f0f0f] text-[#f4f2ef] px-7 py-4 text-[13px] tracking-[0.18em] uppercase [font-family:var(--occ-font-subtitle)] hover:bg-[#1a1a1a] transition-colors disabled:opacity-50 disabled:cursor-not-allowed min-w-[160px] justify-center">
      ...
      {isSuccess && (
        <div role="dialog" aria-modal="true" aria-labelledby="success-title" className="fixed inset-0 bg-[#0f0f0f] text-[#f4f2ef] z-50 flex flex-col items-center justify-center text-center p-10">
          <p className="text-[11px] tracking-[0.25em] text-[#888] uppercase mb-6 [font-family:var(--occ-font-subtitle)]">Enquiry Received</p>
          ...
          <button onClick={() => setIsSuccess(false)} className="text-[12px] tracking-[0.2em] uppercase text-white border-b border-[#555] pb-1 hover:border-white transition-colors [font-family:var(--occ-font-subtitle)]">← Return</button>
        </div>
      )}
    </div>
  )
