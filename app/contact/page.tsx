...
export const metadata: Metadata = {
  title: "Contact | Arunéra Coffee Cambodia - OCC",
  description:
    "Get in touch with Origin Coffee Crafter (OCC). Enquire about wholesale supply, custom roasting programs, barista staffing, or equipment service in Cambodia.",
  keywords:
    "contact OCC Cambodia, coffee wholesale enquiry Phnom Penh, specialty coffee contact Cambodia, coffee supplier contact, OCC enquiry, Arunéra contact",
  alternates: {
