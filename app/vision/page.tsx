...
export const metadata: Metadata = {
  ...
  description: "Discover Arunéra's vision to elevate Cambodia's coffee culture through exceptional roasting, origin transparency, and wholesale technical support. Leading specialty coffee supplier in Phnom Penh.",
        ...
        <main className="max-w-6xl mx-auto pt-32 pb-24 px-8 md:px-16 relative">
          ...
          <footer className="mt-48 pt-12 border-t border-gray-300 flex justify-between items-end">
            <div>
              ...
              <p className="text-sm text-gray-600 font-medium">ARUNÉRA BRANDING</p>
            </div>
