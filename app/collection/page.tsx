      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .occ-collection h1{font-size:116px;margin:18px 0 0}
            .occ-collection h2{font-size:34px;line-height:1.25;letter-spacing:0;margin:0 0 24px;font-weight:500}
            .occ-collection .display-lg{font-size:140px;line-height:.82;letter-spacing:-.055em}
            ...
            @media(max-width:850px){
              .occ-collection h1{font-size:76px}
              .occ-collection .display-lg{font-size:80px}
