...
const allowedHex = new Set(["#292424", "#393235", "#601E27", "#4F171F", "#685F5B", "#D8CEC5", "#E9E1DA", "#F2EDE7", "#F6F3EB", "#F7F4F0"])
const allowedRgb = new Set(["41,36,36", "96,30,39", "104,95,91", "242,237,231", "246,243,235", "247,244,240"])
