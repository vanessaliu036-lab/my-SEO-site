...
if (isVercelProduction) {
  ...
  if (failures.length > 0) {
    console.error(`Blocked production deployment: production must come from GitHub main (${failures.join("; ")}).`)
    process.exit(1)
  }

  console.log(`Production source verified: ${actual.owner}/${actual.repo}@${actual.sha}`)
}
