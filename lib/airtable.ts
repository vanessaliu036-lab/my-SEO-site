...
// OCC_Blog_Posts is the only runtime source of truth after the 2026-08-31
// corpus consolidation. Historical Articles records remain preserved as
// recovery evidence, but the website must never read that legacy table again.
...
// Legacy Indexed is set only on records recovered from the frozen 387-article
// historical public corpus. It protects those URLs from a later editorial SEO
// gate without requiring the runtime to read the legacy Articles table.
